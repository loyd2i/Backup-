...
- **Parrainage** : lien de parrainage pour qui amène un nouveau studio/artiste actif sur la plateforme. Coût quasi nul à mettre en place, levier de croissance classique et éprouvé. **Aucune responsabilité plateforme** : Studiolib ne garantit ni ne finance aucune récompense — chaque studio définit librement sa propre offre de parrainage (texte affiché sur sa fiche publique, ex: "1h offerte"), qu'il honore lui-même directement avec la personne concernée. **Implémenté** : suivi du parrainage (lien, liste des filleuls) et signal "filleul actif" envoyé au parrain à la première session menée à terme (pas la simple inscription) pour qu'il pense à honorer sa propre offre s'il en a une.
