      ...
      <div className="p-6 lg:p-8 max-w-3xl">
        ...
        <div className="bg-[#1a1a1a] rounded-2xl border border-[#2a2a2a] p-6 space-y-4 mt-6">
          ...
          <p className="text-gray-500 text-xs -mt-2">
            ...
            de diffusion publique et dans l&apos;attestation d&apos;auteur. La part de répartition (%) et le
            lien vers un profil sont optionnels ; en le renseignant, le crédit apparaît aussi sur son profil
            public (artiste ou studio) s&apos;il a un compte Studiolib.
          </p>
