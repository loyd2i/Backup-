    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          ...
          className="hidden md:flex items-center gap-2 bg-[#6366f1] text-white px-4 py-2 rounded-lg hover:bg-[#5558e3] transition-colors"
        >
      ...
      <button
        onClick={() => setShowNewPost(true)}
        className="md:hidden fixed bottom-24 right-6 z-30 bg-[#6366f1] text-white p-4 rounded-full shadow-lg hover:bg-[#5558e3] transition-colors"
      >
